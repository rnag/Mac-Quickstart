...
> **_Why?_** Suppose you have 2 GitHub accounts. One for _personal_, and another for _work_. The best (and only) approach for this scenario is setting up SSH with `git`.
